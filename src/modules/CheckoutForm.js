...
class CheckoutForm extends Component {
  ...
  async componentDidMount(){
    ...
    const {data} = await axios.post(process.env.REACT_APP_backendAPI+"/getUserData",{
  ...
  async submit() {
    ...
    try {
      ...
      if(this.props.currentUser !== ""){ // Loggedin
        ...
        response = await axios.post(process.env.REACT_APP_backendAPI+"/createSubscriptionOldUser", {
          token           : token_id,  
        ...
        token_id = responseStripe.token.id;
        console.log(responseStripe);
        response = await axios.post(process.env.REACT_APP_backendAPI+"/createSubscriptionNewUser", {
          token           : token_id,  
          userInfo        : userInfo,
          productData     : productData,
          domainRegistrar : domainRegistrar
